...
|------|------------|------------------|---------------------|
| ![Gemini logo](./images/Google-gemini-icon.svg.png) | **Gemini (LLM)** | Geração de respostas com base no contexto dos documentos recuperados | Modelo multimodal com ótima compreensão textual, reduz alucinações quando usado com RAG |
